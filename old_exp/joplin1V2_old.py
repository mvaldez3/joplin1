...
filename = _thisDir + os.sep + u'data/%s_%s_%s_%s' % (expInfo['participant'], expName, expInfo['session'], expInfo['date'])
...
#set the welcome text based on the session 
if expInfo['session'] == '001':
...
gen_set = sb.gen_build(training_stimuli, '/Volumes/shares/Cabi/exp/joplin/joplin1/stim_files/prototype.csv', randpro, 10, random_seed)

#recode the gen files to match the prototype
sb.cond_file_build('/Volumes/shares/Cabi/exp/joplin/joplin1/data/genfile1.csv')
os.rename('/Volumes/shares/Cabi/exp/joplin/joplin1/data/cond_file.csv', '/Volumes/shares/Cabi/exp/joplin/joplin1/data/genfile1.csv')
sb.cond_file_build('/Volumes/shares/Cabi/exp/joplin/joplin1/data/genfile2.csv')
os.rename('/Volumes/shares/Cabi/exp/joplin/joplin1/data/cond_file.csv', '/Volumes/shares/Cabi/exp/joplin/joplin1/data/genfile2.csv')
...
sb.cond_file_build(training_stimuli)

#rename the file to train_conditions and use this file for the loop.
os.rename('/Volumes/shares/Cabi/exp/joplin/joplin1/data/cond_file.csv', '/Volumes/shares/Cabi/exp/joplin/joplin1/data/_train_cond.csv')
...
for thisTrain_run in train_runs:
    ...
    train_trials = data.TrialHandler(nReps=3.0, method='random', 
        ...
        seed=(int(expInfo['session']) + int(train_runs.thisTrialN)), name='train_trials')
...
for thisTest_run in test_runs:
    ...
    test_trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        seed=(int(expInfo['session']) + int(test_runs.thisTrialN)), name='test_trials')
...
for thisComponent in exp_endComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
os.remove('/Volumes/shares/Cabi/exp/joplin/joplin1/data/_train_cond.csv')
os.remove('/Volumes/shares/Cabi/exp/joplin/joplin1/data/genfile1.csv')
os.remove('/Volumes/shares/Cabi/exp/joplin/joplin1/data/genfile2.csv')
os.remove('/Volumes/shares/Cabi/exp/joplin/joplin1/data/_training_stim.csv')
