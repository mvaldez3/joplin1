...
for thisTrain_run in train_runs:
    ...
    # set up handler to look after randomisation of conditions etc
    train_trials = data.TrialHandler(nReps=2.0, method='random', 
        extraInfo=expInfo, originPath=-1,
    ...
    # completed 2.0 repeats of 'train_trials'
...
for thisTest_run in test_runs:
    ...
    test_trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(gen_file, selection='1:25'),
