...
win.close()
core.quit()
s/shares/Cabi/stimuli/cartoon_animals/Set2/'
...
for thisTrain_run in train_runs:
    ...
    # set up handler to look after randomisation of conditions etc
    train_trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(train_set, selection='1:5'),
    ...
    # completed 1.0 repeats of 'train_trials'
...
test_runs = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('stim_files/test_runs_cond.xlsx', selection='1'),
...
for thisTest_run in test_runs:
    ...
    test_trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(gen_file, selection='1:10'),
