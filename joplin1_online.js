...
function Welcome_Initializing_ScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Welcome_Initializing_ScreenComponents)
...
function recodeTrainRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of recodeTrainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trials_trainLoopBegin(trials_trainLoopScheduler) {
  ...
  for (const thisTrials_train of trials_train) {
...
function stimTrainRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of stimTrainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fix1000RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of fix1000Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function recodeTestRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of recodeTestComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stimTestRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of stimTestComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function debrief_thankyouRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of debrief_thankyouComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
