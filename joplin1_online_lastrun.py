...
expName = 'joplin1_online'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Volumes/shares/Cabi/exp/joplin/joplin1/joplin1_online_lastrun.py',
